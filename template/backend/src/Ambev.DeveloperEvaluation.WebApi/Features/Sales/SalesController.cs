...
using CancelSaleItemValidator = Ambev.DeveloperEvaluation.WebApi.Features.Sales.CancelSaleItem.CancelSaleItemValidator;
...
public class SalesController : BaseController
{
    ...
    /// <param name="itemId">The unique identifier of the sale's item to cancel</param>
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>The cancel operation result</returns>
    [HttpPut("{saleId:guid}/item")]
    [ProducesResponseType(typeof(ApiResponseWithData<CancelSaleItemResponse>), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status400BadRequest)]
    [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status404NotFound)]
    public async Task<IActionResult> CancelSaleItem([FromRoute] Guid saleId, [FromBody] Guid itemId, CancellationToken cancellationToken)
    {
